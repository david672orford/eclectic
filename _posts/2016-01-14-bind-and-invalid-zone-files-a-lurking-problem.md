...
I have looked for a way to test
whether BIND has loaded all of the zones. There is a "rndc status" command but
amazingly it does not report this information. It looks like the best you can
do is ask it to reload all zones and see what shows up in the system log!

So, I
came up with this ridiculous script to run from Cron:
...
If you
run this once a day you will be warned of lurking problems and should have time
to correct them.
