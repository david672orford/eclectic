...
defects which could undermine their security. Normally this works well. Yes,
...
misreported it as a positive. The effect of this was that around July 24th
...
Debian version 11 as an update to a package called "distro-info-data". The
problem was that the announcement of the updated spreadsheet included
...
assessment. So the vulnerability reports which Nessus generated are nonsense.
...
upgrading to version 2.4.65. The problem is that someone at Tenable assumed
...
code on July 7th, three days before version 2.4.64 released. As a consequence
